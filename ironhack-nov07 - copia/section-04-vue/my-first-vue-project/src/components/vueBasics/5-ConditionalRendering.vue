...
<hr>
  ...
  <div id="conditional-rendering-part-5">
    ...
    <!-- el v-show se mantiene el html en el DOM en caso de ser falso (aparece display: none).. caso contrario sucede con el v-if -->
...
<hr>
  <div id="class-excercises">
    <div id="ejercicio1">
      <h2>Ejercicio 01</h2>
      <h1 v-if="reactiveData">Me muestro porque la data reactiva es verdadera</h1>
      <h1 v-else>La data reactiva no puede leerse como verdadera</h1>
      <h1 ></h1>
